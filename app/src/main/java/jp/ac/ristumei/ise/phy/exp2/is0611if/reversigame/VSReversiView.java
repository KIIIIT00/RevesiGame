...
public class VSReversiView extends View implements IPlayerCallback {
    ...
    private String COMLevelValue = String.valueOf(-1);
    private int HF;
    //名前
    private String yourname;
    private String comname;

    public VSReversiView(Context context) {
        super(context);
        ...
        yourname = sp.getYNId();
        comname = sp.getCNId();
        Log.d("COMLEVEL", comlevel);
        Log.d("HumanFirst", String.valueOf(HF));
        Log.d("YourName", yourname);
    ...
    public void init(boolean auto_start){
        ...
        //コンピュータレベルの変更
        if(comlevel == "Level1"){
            COMLevelValue = String.valueOf(1);
        }else if(comlevel == "Level2"){
            COMLevelValue = String.valueOf(2);
        }else if(comlevel == "Level3"){
            COMLevelValue = String.valueOf(3);
        }else if(comlevel == "Level4"){
            COMLevelValue = String.valueOf(1);
        }

        Pref1.setPlayer1(getContext(), String.valueOf(-1));
        Pref1.setPlayer2(getContext(), COMLevelValue);
        Pref1.setPlayer1Name(getContext(), yourname);
        Pref1.setPlayer2Name(getContext(), comname);
